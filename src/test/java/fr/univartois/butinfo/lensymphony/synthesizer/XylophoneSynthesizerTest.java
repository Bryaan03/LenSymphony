...
class XylophoneSynthesizerTest {
    ...
    @Test
    void testXylophoneSamples() {
        XylophoneSynthesizer xylophone = XylophoneSynthesizer.getInstance();
        double[] samples = xylophone.synthesize(note, TEMPO, VOLUME);
